...
function render(d){
 ...
 <div class="grid g4">
  ...
  <div class="card hot"><div class=k>Network Hashrate</div><div class="v cy">${d.nethps_ph} <small>PH/s</small></div><div class=s>≈ ${fmt(d.nethps_th)} TH/s all miners</div></div>
